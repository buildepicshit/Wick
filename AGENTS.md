...
- **Current test count:** 203 unit tests (`Wick.Tests.Unit`) + 12 integration tests (`Wick.Tests.Integration`), 215 total, all passing. See [`STATUS.md`](STATUS.md) for up-to-date counts.
